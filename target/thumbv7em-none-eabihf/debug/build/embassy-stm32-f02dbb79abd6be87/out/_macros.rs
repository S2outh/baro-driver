macro_rules ! set_clocks { ($ ($ (# [$ m : meta]) * $ k : ident : $ v : expr ,) *) => { { # [allow (unused)] struct Temp { $ ($ (# [$ m]) * $ k : Option < crate :: time :: Hertz > ,) * } let all = Temp { $ ($ (# [$ m]) * $ k : $ v ,) * } ; crate :: rcc :: set_freqs (crate :: rcc :: Clocks { csi : all . csi . into () , hclk1 : all . hclk1 . into () , hclk2 : all . hclk2 . into () , hclk3 : all . hclk3 . into () , hclk4 : all . hclk4 . into () , hse : all . hse . into () , hsi : all . hsi . into () , hsi48 : all . hsi48 . into () , i2s_ckin : all . i2s_ckin . into () , lse : all . lse . into () , lsi : all . lsi . into () , pclk1 : all . pclk1 . into () , pclk1_tim : all . pclk1_tim . into () , pclk2 : all . pclk2 . into () , pclk2_tim : all . pclk2_tim . into () , pclk3 : all . pclk3 . into () , pclk4 : all . pclk4 . into () , pll1_q : all . pll1_q . into () , pll2_p : all . pll2_p . into () , pll2_q : all . pll2_q . into () , pll2_r : all . pll2_r . into () , pll3_p : all . pll3_p . into () , pll3_q : all . pll3_q . into () , pll3_r : all . pll3_r . into () , rtc : all . rtc . into () , sys : all . sys . into () , }) ; } } ; }
#[allow(unused)]
...
macro_rules! foreach_interrupt {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_interrupt_inner!((DCMI,dcmi,DCMI,GLOBAL,DCMI_PSSI));
        ...
        __foreach_interrupt_inner!((DTS,dts,DTS,GLOBAL,DTS));
        ...
        __foreach_interrupt_inner!((I2C5,i2c,I2C,ER,I2C5_ER));
        __foreach_interrupt_inner!((I2C5,i2c,I2C,EV,I2C5_EV));
        ...
        __foreach_interrupt_inner!((LTDC,ltdc,LTDC,ER,LTDC_ER));
        __foreach_interrupt_inner!((LTDC,ltdc,LTDC,GLOBAL,LTDC));
        __foreach_interrupt_inner!((MDIOS,mdios,MDIOS,GLOBAL,MDIOS));
        __foreach_interrupt_inner!((MDIOS,mdios,MDIOS,WKUP,MDIOS_WKUP));
        __foreach_interrupt_inner!((OCTOSPI1,octospi,OCTOSPI,GLOBAL,OCTOSPI1));
        __foreach_interrupt_inner!((OCTOSPI2,octospi,OCTOSPI,GLOBAL,OCTOSPI2));
        __foreach_interrupt_inner!((PSSI,pssi,PSSI,GLOBAL,DCMI_PSSI));
        ...
        __foreach_interrupt_inner!((SAI4,sai,SAI,A,SAI4));
        __foreach_interrupt_inner!((SAI4,sai,SAI,B,SAI4));
        __foreach_interrupt_inner!((SDMMC1,sdmmc,SDMMC,GLOBAL,SDMMC1));
        __foreach_interrupt_inner!((SDMMC2,sdmmc,SDMMC,GLOBAL,SDMMC2));
        __foreach_interrupt_inner!((SPDIFRX1,spdifrx,SPDIFRX,GLOBAL,SPDIF_RX));
        ...
        __foreach_interrupt_inner!((TIM23,timer,TIM_GP32,BRK,TIM23));
        __foreach_interrupt_inner!((TIM23,timer,TIM_GP32,CC,TIM23));
        __foreach_interrupt_inner!((TIM23,timer,TIM_GP32,COM,TIM23));
        __foreach_interrupt_inner!((TIM23,timer,TIM_GP32,TRG,TIM23));
        __foreach_interrupt_inner!((TIM23,timer,TIM_GP32,UP,TIM23));
        __foreach_interrupt_inner!((TIM24,timer,TIM_GP32,BRK,TIM24));
        __foreach_interrupt_inner!((TIM24,timer,TIM_GP32,CC,TIM24));
        __foreach_interrupt_inner!((TIM24,timer,TIM_GP32,COM,TIM24));
        __foreach_interrupt_inner!((TIM24,timer,TIM_GP32,TRG,TIM24));
        __foreach_interrupt_inner!((TIM24,timer,TIM_GP32,UP,TIM24));
        ...
        __foreach_interrupt_inner!((UART9,usart,USART,GLOBAL,UART9));
        __foreach_interrupt_inner!((USART1,usart,USART,GLOBAL,USART1));
        __foreach_interrupt_inner!((USART10,usart,USART,GLOBAL,USART10));
        ...
        __foreach_interrupt_inner!((DCMI_PSSI));
        ...
        __foreach_interrupt_inner!((OCTOSPI1));
        ...
        __foreach_interrupt_inner!((DTS));
        __foreach_interrupt_inner!((WAKEUP_PIN));
        __foreach_interrupt_inner!((OCTOSPI2));
        __foreach_interrupt_inner!((FMAC));
        __foreach_interrupt_inner!((CORDIC));
        __foreach_interrupt_inner!((UART9));
        __foreach_interrupt_inner!((USART10));
        __foreach_interrupt_inner!((I2C5_EV));
        __foreach_interrupt_inner!((I2C5_ER));
        __foreach_interrupt_inner!((FDCAN3_IT0));
        __foreach_interrupt_inner!((FDCAN3_IT1));
        __foreach_interrupt_inner!((TIM23));
        __foreach_interrupt_inner!((TIM24));
    };
}
#[allow(unused)]
macro_rules! foreach_peripheral {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_peripheral_inner!((dts,DTS));
        ...
        __foreach_peripheral_inner!((i2c,I2C5));
        ...
        __foreach_peripheral_inner!((ltdc,LTDC));
        __foreach_peripheral_inner!((mdios,MDIOS));
        __foreach_peripheral_inner!((octospi,OCTOSPI1));
        __foreach_peripheral_inner!((octospi,OCTOSPI2));
        __foreach_peripheral_inner!((octospim,OCTOSPIM));
        __foreach_peripheral_inner!((opamp,OPAMP1));
        __foreach_peripheral_inner!((opamp,OPAMP2));
        __foreach_peripheral_inner!((pssi,PSSI));
        ...
        __foreach_peripheral_inner!((spdifrx,SPDIFRX1));
        ...
        __foreach_peripheral_inner!((timer,TIM23));
        __foreach_peripheral_inner!((timer,TIM24));
        ...
        __foreach_peripheral_inner!((usart,UART9));
        __foreach_peripheral_inner!((uid,UID));
        __foreach_peripheral_inner!((usart,USART1));
        __foreach_peripheral_inner!((usart,USART10));
...
macro_rules! foreach_adc {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_adc_inner!((ADC3,ADC3_COMMON,adc));
    };
}
